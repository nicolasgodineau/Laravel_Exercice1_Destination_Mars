...
<body
    class="bg-repeat bg-contain w-[1440px] h-[100vh] flex flex-col items-center justify-items-center mx-auto my-0  p-7 text-white" style="background-image: url({{ url('assets/img/background.jpg')}});">
    <main
    class="bg-no-repeat bg-cover w-[100%] h-[100%] flex flex-col items-center justify-between rounded-[30px] pt-5" style="background-image: url({{ url('assets/img/home.webp')}});">
